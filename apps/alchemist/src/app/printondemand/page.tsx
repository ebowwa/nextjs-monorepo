...
import GeminiProdAndConvertedImagesDetails from '@/components/sections/printondemand/result/GeminiProdAndConvertedImagesDetails/page';

// Dynamically import the ConvertWebp2Png component with SSR disabled
const ConvertWebp2Png = dynamic(() => import('@/components/images/ConvertWebp2Png'), {
